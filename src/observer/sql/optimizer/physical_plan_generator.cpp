...
RC PhysicalPlanGenerator::create_plan(ProjectLogicalOperator &project_oper, unique_ptr<PhysicalOperator> &oper)
{
  ...
  project_operator->add_all_expressions(project_oper.all_expressions());
...
RC PhysicalPlanGenerator::create_plan(AggLogicalOperator &agg_oper, unique_ptr<PhysicalOperator> &oper)
{
  ...
  AggPhysicalOperator *agg_operator = new AggPhysicalOperator(agg_oper.attributes(),agg_oper.fields(),agg_oper.my_expressions(),agg_oper.group_fields(),agg_oper.having_expression(),agg_oper.having_rels(),agg_oper.having_fields());
