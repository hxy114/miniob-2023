...
{
public:
  ViewUpdatePhysicalOperator(Table *table, std::vector<const FieldMeta *>field_meta, std::map<int,Value> value,std::map<int,int>select_map)
...
private:
  ...
  std::vector<const FieldMeta *>origin_field_meta_;
